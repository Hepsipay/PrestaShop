...
<div class="col-md-12">
    <p>
        <img id="hepsipay-logo" src="{$baseUri}/logo.png" alt="Hepsipay">
    </p>
            ...
            <div class="checkout_form">
                ...
                <div class="form-group" id="installment_table_id">
                    <div class="installmet_head">
                        ...
                        <div class="install_head_label">{l s='Amount / Month' mod='hepsipay'} ({$currency|escape:'html':'UTF-8'})</div>
                        <div class="install_head_label">{l s='Total' mod='hepsipay'} ({$currency|escape:'html':'UTF-8'})</div>
                    </div>
